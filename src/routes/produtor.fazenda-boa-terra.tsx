        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 relative pb-8">
          <div className="flex flex-col md:flex-row md:items-end gap-6 md:gap-8 -mt-20 md:-mt-24 relative z-10 mb-6">
            ...
            <div className="md:pb-4 flex w-full md:w-auto mt-4 md:mt-0">
              <Link 
                to="/catalogo"
                className="w-full md:w-auto flex items-center justify-center gap-2 bg-primary text-primary-foreground px-6 py-3 rounded-xl font-bold hover:opacity-90 transition-all shadow-sm"
              >
        ...
        <div className="lg:col-span-2 space-y-10">
          ...
          <section id="produtos" className="pt-4">
            ...
            <div className="mt-8 text-center">
              <Link
                to="/catalogo"
                className="inline-flex items-center gap-2 px-6 py-3.5 rounded-xl border-2 border-border text-foreground font-bold hover:bg-muted transition-colors"
              >
